...
const Demo = () => {
    const [article,
        setArticle] = useState({url: '', summary: ''});

    const [AllArticles,
        setAllArticles] = useState([]);
    ...
    const handleSubmit = async(e) => {
        ...
        e.preventDefault();
        const {data} = await getSummmary({articleUrl: article.url});
        ...
        <section className="mt-16 w-full max-w-xl">
            ...
            <div className="flex flex-col w-full gap-2">
                <form
                    ...
                    <button
                        type="submit"
                        className="submit_btn flex peer-focus:border-gray-700 peer-focus:text-gray-700">
                        Submit
                    </button>
                </form>
                {/* Browse URL history */}
